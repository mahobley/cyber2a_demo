...
export const lessonMetadata = [
  {
    ...
    "description": "Guide students through bias correction and parameter tuning for coupled climate models using real-world reanalysis products.",
    "styles": [
      "Active Learning",
      "Lab"
    ],
    ...
    "authors": [
      {
        "name": "Dr. Amara Singh",
        "institution": "Center for Earth System Science"
      },
      {
        "name": "Prof. Liam Ortega",
        "institution": "Coastal Climate Laboratory"
      }
    ],
    "navigation": {
      "previous": null,
    ...
    "id": "geo-module-01",
    "courseId": "earth-systems-analytics-2024",
    ...
    "datasets": [
      {
        ...
        "citation": "European Centre for Medium-Range Weather Forecasts (2023). ERA5 Reanalysis Subset.",
        "sizeCategory": "Large",
        "dataTypes": [
          "Gridded Time Series",
          "NetCDF"
      ...
      },
      {
        ...
        "citation": "Singh, A. (2024). Global Carbon Flux Inventory v3. Center for Earth System Science.",
        "sizeCategory": "Medium",
        "dataTypes": [
          "Tabular Aggregates",
          "Raster Grids"
  ...
  },
  {
    ...
    "description": "Hands-on experience with multispectral imagery, surface reflectance correction, and vegetation index derivation.",
    "styles": [
      "Lab"
    ],
    "audience": [
    ...
    "datasets": [
      {
        ...
        "citation": "European Space Agency (2024). Sentinel-2 L2A Surface Reflectance (custom region subset).",
        "sizeCategory": "Large",
        "dataTypes": [
      ...
      },
      {
        ...
        "citation": "Ortega, L. (2023). Coastal Canopy LiDAR Products. Coastal Climate Laboratory.",
        "sizeCategory": "Medium",
        "dataTypes": [
          "Point Clouds",
          "Raster Grids"
  ...
  },
  {
    ...
    "description": "Capstone studio where teams evaluate flood mitigation strategies under future climate projections and land-use change.",
    "styles": [
      "Active Learning",
      "Lecture"
    ],
    ...
    "datasets": [
      {
        ...
        "citation": "National Hydrologic Observatory (2024). River Discharge Archive.",
        "sizeCategory": "Medium",
        "dataTypes": [
          "Time Series",
          "CSV"
      ...
      },
      {
        ...
        "citation": "Ortega, L. & Singh, A. (2024). Coastal Watershed Land Use Projections.",
        "sizeCategory": "Medium",
        "dataTypes": [
          "Raster Grids",
          "GeoTIFF"
...
export const courseCatalog = [
  {
    "id": "earth-systems-analytics-2024",
    "title": "Earth Systems Analytics Syllabus 2024",
    "summary": "Designed and curated by <strong>Dr. Amara Singh</strong> to guide advanced learners through climate, hydrologic, and landscape resilience analytics.",
    "coordinators": [
      {
        "name": "Dr. Amara Singh",
        "institution": "Center for Earth System Science",
